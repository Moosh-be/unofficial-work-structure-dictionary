...
Méthodes et cadres méthodologiques référencés ou analysés dans le Work Structure Dictionary.
...
| Méthode | Lien | Objets couverts | Relation avec la norme |
|---------|------|-----------------|----------------------|
| **ITIL 4** | [axelos.com/ITIL](https://axelos.com/certifications/itil-service-management) | Incidents, Problems, Changes, ConfigurationItems, SLA, KPI | Cadre de gestion de services |
| **COBIT** | [isaca.org/cobit](https://isaca.org/resources/cobit) | Governance, Decisions, Risks, ConfigurationItems, Compliance | Gouvernance IT |
...
- `eu/` — Contexte EU (PM²)
- `safer/` — Contexte SAFe
- `agile/` — Contexte Agile (Scrum, Kanban)
